...
def score_single_event_primary(X, id_num):
    """
    ...
    clf_list, clf_names = helpers.ml_utils.load_classifier_list(id_num, 'primary')
...
def main():
    ...
    logger.info("Loading existing primary model for classifying single event...")
    ...
    score_single_event_primary(X, id_num)
